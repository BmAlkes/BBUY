...
import { getOrder, payOrder, deliverOrder, getPaypalClientId } from '../api';
        ...
        <div class="order-action">
           <ul>
                <li>
                 ...
                 <li> <div class="fw" id="paypal-button">
                 <li>
                  ${isPaid && !isDelivered && isAdmin ?` <button class="primary fw" id="deliver-order-button">Deliver Order</button>` : '' }
                 </li>
